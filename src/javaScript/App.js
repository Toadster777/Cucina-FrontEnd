...
function App() {
  ...
  const  requestMenusPipera = async () => {
    await fetch("https://backend-cucina-4d60cb73f5a9.herokuapp.com/api/menus?populate=*")
  ...
  const  requestMenusGara = async () => {
    await fetch("https://backend-cucina-4d60cb73f5a9.herokuapp.com/api/menu-gara-de-nords?populate=*")
      .then((response) =>response.json())
      .then((data) => {
  ...
  const  requestTexts = async () => {
    await fetch("https://backend-cucina-4d60cb73f5a9.herokuapp.com/api/texts")
      .then((response) =>response.json())
      .then((data) => {
          setTexts(data.data)
      }) 
  ...
  const  requestCardInfo = async () => {
    await fetch("https://backend-cucina-4d60cb73f5a9.herokuapp.com/api/locations")
      .then((response) =>response.json()) 
      .then((data) => {
          setLCData(data.data)
      }) 
