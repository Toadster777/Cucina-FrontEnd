  ...
  return (
      ...
      data.map(location => {
        return (
          ...
          <div id = "LocationCard" className='flex flex-col justify-start bg-oliveGreen locationCard my-20 p-8 pb-4 gap-10 rounded-md text-white h-auto'>
            <div className='flex justify-center'>
              ...
              <div className='flex flex-col justify-center gap-4'>
                <button type='button' className=' bg-white text-black text-base rounded py-2 locationCardBtn font-semibold'><a href='/Menus'>VEZI MENIUL</a></button>
