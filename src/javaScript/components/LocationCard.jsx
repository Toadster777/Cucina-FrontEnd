          ...
          <div id = "LocationCard" className='flex flex-col justify-start bg-oliveGreen locationCard my-12 p-8 pb-4 gap-10 rounded-md text-white h-auto w-auto'>
            <div className='flex justify-center'>
              ...
              <div className='flex flex-col justify-center gap-4'>
                <a href={location.attributes.apiUrl} className = " bg-white text-black text-base rounded py-2 locationCardBtn font-semibold text-center">VEZI MENIUL</a>
                <a href={`tel:${location.attributes.phoneNo}`} className='text-base text-black bg-white rounded py-2 locationCardBtn font-semibold text-center flex content-center justify-center gap-4'><svg fill="#000000" height="24px" width="24px" version="1.1" id="Capa_1" viewBox="0 0 473.806 473.806"><g>
                <g>
