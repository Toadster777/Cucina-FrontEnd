...
export const Privacy = () => {
  return (
    <div className='contentContainer font-gVibes'>
                <h1>Privacy Policy</h1>
        <p>Updated at 2023-03-20</p>

        <p> CucinaRomana (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by CucinaRomana.</p>
        <p>This Privacy Policy applies to our website, and its associated subdomains (collectively, our “Service”) alongside our application, CucinaRomana. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.</p>
        ...
        <li>Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Richvelo SRL, Str. Cuza Voda 53  that is responsible for your information under this Privacy Policy.</li>
        <li>Country: where CucinaRomana or the owners/founders of CucinaRomana are based, in this case is Romania</li>
        <li>Customer: refers to the company, organization or person that signs up to use the CucinaRomana Service to manage the relationships with your consumers or service users.</li>
        <li>Device: any internet connected device such as a phone, tablet, computer or any other device that can be used to visit CucinaRomana and use the services.</li>
        ...
        <li>Personnel: refers to those individuals who are employed by CucinaRomana or are under contract to perform a service on behalf of one of the parties.</li>
        ...
        <li>Service: refers to the service provided by CucinaRomana as described in the relative terms (if available) and on this platform.</li>
        ...
        <li>Website: CucinaRomana's site, which can be accessed via this URL: www.cucinaromana.ro</li>
        <li>You: a person or entity that is registered with CucinaRomana to use the Services.</li>
        </ul>
        </p>
        ...
        <h1>Personnel</h1>
        <p>If you are a CucinaRomana worker or applicant, we collect information you voluntarily provide to us. We use the information collected for Human Resources purposes in order to administer benefits to workers and screen applicants.</p>
        ...
        <p>We reserve the right to transfer information to a third party in the event of a sale, merger or other transfer of all or substantially all of the assets of CucinaRomana or any of its Corporate Affiliates (as defined herein), or that portion of CucinaRomana or any of its Corporate Affiliates to which the Service relates, or in the event that we discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.</p>

        <h1>Affiliates</h1>
        <p>We may disclose information (including personal information) about you to our Corporate Affiliates. For purposes of this Privacy Policy, "Corporate Affiliate" means any person or entity which directly or indirectly controls, is controlled by or is under common control with CucinaRomana, whether by ownership or otherwise. Any information relating to you that we provide to our Corporate Affiliates will be treated by those Corporate Affiliates in accordance with the terms of this Privacy Policy.</p>

        <h1>Governing Law</h1>
        <p>This Privacy Policy is governed by the laws of Romania without regard to its conflict of laws provision. You consent to the exclusive jurisdiction of the courts in connection with any action or dispute arising between the parties under or in connection with this Privacy Policy except for those individuals who may have rights to make claims under Privacy Shield, or the Swiss-US framework.</p>
        <p>The laws of Romania, excluding its conflicts of law rules, shall govern this Agreement and your use of the website. Your use of the website may also be subject to other local, state, national, or international laws.</p>
        <p>By using CucinaRomana or contacting us directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy Policy, you should not engage with our website, or use our services. Continued use of the website, direct engagement with us, or following the posting of changes to this Privacy Policy that do not significantly affect the use or disclosure of your personal information will mean that you accept those changes.</p>
        ...
        <p>You acknowledge and agree that CucinaRomana shall not be responsible for any Third-Party Services, including their accuracy, completeness, timeliness, validity, copyright compliance, legality, decency, quality or any other aspect thereof. CucinaRomana does not assume and shall not have any liability or responsibility to you or any other person or entity for any Third-Party Services.</p>
        ...
        <ul><li>Google Maps API
            ...
            <p>Google Maps API collects information that is held in accordance with its Privacy Policy</p></li><li>Cookies
            ...
            <p>$elnombre uses "Sessions" to identify the areas of our website that you have visited. A Session is a small piece of data stored on your computer or mobile device by your web browser.</p></li>
        </ul>
        ...
        <ul><li>Via Phone Number:  0722670984</li>
        </ul>
    </div>
  )
}
